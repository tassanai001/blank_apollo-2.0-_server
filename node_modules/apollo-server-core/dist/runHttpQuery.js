...
function throwHttpGraphQLError(statusCode, errors, optionsObject) {
    throw new HttpQueryError(statusCode, prettyJSONStringify({
        errors: apollo_server_errors_1.formatApolloErrors(errors, {
    ...
    return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (extensions && extensions.persistedQuery) {
                    if (!optionsObject.persistedQueries ||
                        ...
                        throwHttpGraphQLError(200, [new apollo_server_errors_1.PersistedQueryNotSupportedError()], optionsObject);
                    }
                    ...
                    if (queryString === undefined) {
                        ...
                        if (queryString) {
                            ...
                            throwHttpGraphQLError(200, [new apollo_server_errors_1.PersistedQueryNotFoundError()], optionsObject);
                        }
                    }
                    else {
                ...
                return {
                    errors: apollo_server_errors_1.formatApolloErrors([e], {
                        formatter: optionsObject.formatError,
                        debug: optionsObject.debug,
                    }),
                };
        ...
        if (!isBatch) {
            ...
            if (graphqlResponse.errors && typeof graphqlResponse.data === 'undefined') {
                throwHttpGraphQLError(400, graphqlResponse.errors, optionsObject);
            }
            const stringified = prettyJSONStringify(graphqlResponse);
            responseInit['Content-Length'] = Buffer.byteLength(stringified, 'utf8').toString();
            return {
